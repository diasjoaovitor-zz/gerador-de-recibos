...
function document(name, RG, salary, year, period, value, extensive, date) {
  const docDefinition = {
    content: [
      {
      ...
      {
        text: `Recebi da empresa João Pedro Ferreira dos Santos, estabelecida na Praça do Mercado, 190, em Poções – BA, no ano de ${year}, a importação de ${value} – ${extensive}, a qual prestei serviço e dou o meu ciente. `,
        margin: [0, 30, 0, 10]
      },
      {
